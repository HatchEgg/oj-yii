    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Edit Contest</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group col-lg-5">
                                    ...
                                    <input class="form-control" type="text" name="contest-teacher" id="contest-teacher"
                                        value="<?=$contest->teacher?>">
                                </div>
                                <div class="form-group col-lg-12">
                                    <label for="contest-description">竞赛简介</label>
                                    <textarea class="form-control" id="contest-description"><?=$contest->description?></textarea>
                                </div>
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="text" name="contest-time" id="contest-time" class="form-control" id="contest-description"
                                        value="<?=$contest->start_date.' - '.$contest->end_date?>"
                                    >
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                <div class="checkbox">
                                    <label>
                                        <input id="contest-available" type="checkbox" name="contest-option" 
                                            <?php if($contest->available) echo "checked";?>>是否可见
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input id="contest-sign" type="checkbox" name="contest-option"
                                            <?php if($contest->can_sign) echo "checked";?>>是否允许报名
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input id="contest-secret" type="checkbox" name="contest-option"
                                            <?php if($contest->need_password) echo "checked";?>>是否需要密码
                                    </label>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-lg-12">
                    <div style="margin-left: auto;margin-right: auto;margin-bottom: 180px;">
                        <button id="add-contest" class="btn btn-info input-lg" style="width: 100%;">完成修改</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="../dist/js/admin-contest-edit.js"></script>
    <script src="../dist/request/admin-contest-edit.js"></script>
